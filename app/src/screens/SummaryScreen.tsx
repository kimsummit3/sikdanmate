  ...
  return (
    <ScrollView contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>초기 식단메이트는 정밀 분석보다, 유지율과 복귀율을 먼저 보여주는 방향으로 갑니다.</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 16, lineHeight: 24, color: colors.textMuted, maxWidth: 320 },
  highlightCard: { backgroundColor: colors.greenSurface, borderRadius: 24, padding: 20, marginBottom: 18 },
  highlightLabel: { fontSize: 12, fontWeight: '700', color: colors.greenDeep, marginBottom: 10 },
  ...
  metricCard: { width: '48%', backgroundColor: colors.white, borderRadius: 22, padding: 18, shadowColor: colors.greenDeep, shadowOpacity: 0.06, shadowRadius: 16, shadowOffset: { width: 0, height: 6 }, elevation: 2 },
  ...
  noteCard: { backgroundColor: colors.white, borderRadius: 24, padding: 20, marginBottom: 18 },
  noteLabel: { fontSize: 12, fontWeight: '700', color: colors.greenDeep, marginBottom: 10 },
  noteTitle: { fontSize: 22, fontWeight: '800', color: colors.text, lineHeight: 30 },
  primaryButton: { backgroundColor: colors.greenButton, borderRadius: 16, paddingVertical: 15, alignItems: 'center' },
